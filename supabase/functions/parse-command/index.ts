...
const COMMAND_SCHEMA = {
  ...
  properties: {
    ...
    repeat: { anyOf: [{ type: "string", enum: ["none", "weekly", "biweekly", "course12"] }, { type: "null" }] },
...
Deno.serve(async (req: Request) => {
  ...
  const response = await anthropic.messages.create({
    ...
    system: [
      ...
      "- A '12-week course', 'full course of treatment', or 'Monday through Thursday treatment' means repeat=course12 (4 visits/week, Mon-Thu, for 12 weeks).",
